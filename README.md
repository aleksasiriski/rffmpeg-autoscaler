...
If you need a reference docker compose file use [this one](https://github.com/aleksasiriski/rffmpeg-autoscaler/blob/main/docker-compose/docker-compose.example.yml).
