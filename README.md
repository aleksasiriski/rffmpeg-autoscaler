...
| HETZNER_CLOUD_INIT | [string](https://github.com/aleksasiriski/rffmpeg-autoscaler) | The string that setups the workers after creation, the default uses my docker compose and inserts needed env variables |
